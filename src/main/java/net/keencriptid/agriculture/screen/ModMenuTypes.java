package net.keencriptid.agriculture.screen;
...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(Registries.MENU, Agriculture.MOD_ID);
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<DutchOvenMenu>> DUTCH_OVEN_MENU =
            registerMenuType("dutch_oven_menu", DutchOvenMenu::new);
